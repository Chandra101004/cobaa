...
public class StackArray<E> {
    ...
    public StackArray(int length) {
        this.stackArr = new Object[length];
        this.elementCount =0;
    }
    ...
    public static double operation(double operand1, Object operand2, String token) {
        return 0;
    }

    public static double operation(Object operand1, Object operand2, String token) {
        return 0;
    }
}
